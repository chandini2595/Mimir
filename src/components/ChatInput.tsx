      ...
      <div className="bg-white/80 backdrop-blur-xl border border-slate-200/80 rounded-2xl p-3 shadow-lg">
        ...
        <div className="flex items-center justify-between mt-2">
          <div className="flex items-center gap-2">
            <button onClick={handleAttachClick} className="flex items-center gap-2 px-3 py-1.5 text-sm text-slate-600 bg-white/50 rounded-lg shadow-sm border border-slate-200 hover:bg-slate-100 transition-colors">
          ...
          <button onClick={handleSend} disabled={!message.trim()} className="w-9 h-9 flex items-center justify-center rounded-full bg-black text-white disabled:bg-slate-300 transition-colors">
